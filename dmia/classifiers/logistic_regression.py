...
class LogisticRegression:
    ...
    def predict_proba(self, X, append_bias=False):
        ...
        # y_predictions = sigmoid(X.dot(self.w))
        y_predictions = 1.0 / (1.0 + np.exp(-X.dot(self.w)))
